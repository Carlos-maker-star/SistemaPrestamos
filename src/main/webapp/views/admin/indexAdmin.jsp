<%-- 
    ...
    Created on : 11 mar. 2025, 22:54:21
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="row align-items-center mb-2">
                                <div class="col">
                                    <h2 class="h5 page-title">Welcome! <%= usuario.getNombre()%></h2>
                                </div>
                                <div class="col-auto">
                                        ...
                                        <div class="card-body" data-simplebar style="height:355px; overflow-y: auto; overflow-x: hidden;">
                                            ...
                                            <div class="pb-3 timeline-item item-warning">
                                                <div class="pl-5">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col"><img src="<%=request.getContextPath()%>/assets/products/p1.jpg" alt="..." class="img-fluid rounded"></div>
                                                        <div class="col"><img src="<%=request.getContextPath()%>/assets/products/p2.jpg" alt="..." class="img-fluid rounded"></div>
                                                        <div class="col"><img src="<%=request.getContextPath()%>/assets/products/p3.jpg" alt="..." class="img-fluid rounded"></div>
                                                        <div class="col"><img src="<%=request.getContextPath()%>/assets/products/p4.jpg" alt="..." class="img-fluid rounded"></div>
                                                    </div>
