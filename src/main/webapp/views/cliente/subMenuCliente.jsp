<%-- 
    Document   : subMenuCliente
    Created on : 31 mar. 2025, 20:52:34
...
<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    <div class="text-center mt-3">
        <h4 class="font-weight-bold mt-4 mb-2">CLIENTE</h4>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item w-100">
                <a class="nav-link" href="<%=request.getContextPath()%>/PrestamoServlet?accion=listarPrestamosCliente">
                    <i class="fe fe-user fe-16"></i>
                    <span class="ml-3 item-text">Prestamos</span>
                </a>
                    <a class="nav-link" href="<%=request.getContextPath()%>/PagoServlet?accion=listarPagosCliente">
                    <i class="fe fe-user fe-16"></i>
                    <span class="ml-3 item-text">Pagos</span>
                </a>
            </li>
        </ul>
    </nav>
